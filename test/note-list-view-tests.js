(function(exports) {
  ...
  function viewTestSeveral() {
    ...
    var list = new List();
    list.createAndStore("Favourite food: pesto");
    list.createAndStore("Favourite drink: seltzer");
    list.createAndStore("Favourite dessert: cake");
    var view = new View(list);

    if(view.displayHTML() !== "<ul><li><div>Favourite food: pesto</div></li><li><div>Favourite drink: seltzer</div></li><li><div>Favourite dessert: cake</div></li></ul>") {
