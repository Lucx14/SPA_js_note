(function(exports) {
  ...
  function viewTestSeveral() {
    ...
    var result = '<ul><li><div><a href="#note">0: Favourite food: pest...</a></div></li><li><div><a href="#note">1: Favourite drink: sel...</a></div></li><li><div><a href="#note">2: Favourite dessert: c...</a></div></li></ul>'
  ...
  function viewTestOne() {
    ...
    var view = new View(list);
    var result = '<ul><li><div><a href="#note">0: Test...</a></div></li></ul>';
  ...
  function viewTestEmpty() {
    var list = new List();
    var view = new View(list);
    var result = '<ul><li><div><a href="#note"></a></div></li></ul>';
